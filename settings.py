...
languages = {,    "ml": {
        "help": "TikTok വീഡിയോകളോ ചിത്രങ്ങളോ എളുപ്പത്തിൽ ഡൗൺലോഡ് ചെയ്യാം😊\nഎനിക്ക് ഒരു ലിങ്ക് അയച്ചു തരൂ.",
        "invalid_link": "ലിങ്ക് ശരിയല്ല, ദയവായി ശരിയായ ലിങ്ക് അയക്കുക.",
        "wait": "ദയവായി കാത്തിരിക്കൂ!\nവീഡിയോ തയ്യാറായിക്കൊണ്ടിരിക്കുന്നു...",
        "likes": "ലൈക്കുകൾ",
        "comments": "കമന്റുകൾ",
        "share": "ഷെയറുകൾ",
        "views": "കാഴ്ചക്കാർ",
        "nickname": "നിക്ക്നെയിം",
        "large_for_tg": "വീഡിയോയുടെ സൈസ് കൂടുതലാണ് (20 MB കൂടുതൽ), എങ്കിലും ലിങ്ക് വഴി ഡൗൺലോഡ് ചെയ്യാം:",
    },
